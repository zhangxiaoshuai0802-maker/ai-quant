...
plt.tight_layout()
plt.savefig('reports/multi_source/price_comparison.png', dpi=100, bbox_inches='tight')
plt.close()

print('  ✓ 已保存至：reports/multi_source/price_comparison.png')
...
plt.tight_layout()
plt.savefig('reports/multi_source/price_difference.png', dpi=100, bbox_inches='tight')
plt.close()

print('  ✓ 已保存至：reports/multi_source/price_difference.png')
...
plt.tight_layout()
plt.savefig('reports/multi_source/price_difference_distribution.png', dpi=100, bbox_inches='tight')
plt.close()

print('  ✓ 已保存至：reports/multi_source/price_difference_distribution.png')
...
<body>
    <div class="container">
        ...
        <div class="chart">
            ...
            <img src="../reports/multi_source/price_comparison.png" alt="收盘价对比">
            <p>Tushare 与 Akshare 的未复权数据完全重叠，Yfinance 数据存在明显差异。</p>
        </div>
        
        <div class="chart">
            <h3>图 2: 价格差异时间序列</h3>
            <img src="../reports/multi_source/price_difference.png" alt="价格差异">
            <p>上图显示各数据源间的价格差异随时间的变化。</p>
        </div>
        
        <div class="chart">
            <h3>图 3: 价格差异分布</h3>
            <img src="../reports/multi_source/price_difference_distribution.png" alt="价格差异分布">
...
print('=' * 80)
print('\n输出文件：')
print('  1. reports/multi_source/price_comparison.png - 收盘价对比图')
print('  2. reports/multi_source/price_difference.png - 价格差异时间序列图')
print('  3. reports/multi_source/price_difference_distribution.png - 价格差异分布图')
print('  4. reports/multi_source/comparison_report.html - HTML 对比报告')
